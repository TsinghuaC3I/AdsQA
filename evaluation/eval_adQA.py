...
if __name__ == "__main__":
    ...
    args.add_argument('--model_dir', type=str, default="/mnt/public/tk/models/readr-step240")  # dir to save the checkpoints, e.g., qwen2.5-vl
    args.add_argument('--model_name', type=str, default='readr-step240')  # prediction file name. This script will create a directory for each question (named with its question_id), inside which the prediction result from each model will be saved using the given prediction name.
